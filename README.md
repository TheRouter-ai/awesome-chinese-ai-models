...
- 2026-07-11 `open_source` [QwenLM/qwen-code release Release v0.19.8-nightly.20260711.0ef3a76bd](https://github.com/QwenLM/qwen-code/releases/tag/v0.19.8-nightly.20260711.0ef3a76bd) — <!-- Release notes generated using configuration in .github/release.yml at release/v0.19.8-nightly.20260711.0ef3a76bd -->  ## What's Changed * fix(core): keep YOLO mode when the model calls enter_plan_mode by @Nas01010101 in https://github.
- 2026-07-10 `model_update` [Hugging Face model update: tencent/HiLS-Attention-7B](https://huggingface.co/tencent/HiLS-Attention-7B) — Model card/update on Hugging Face. Tags: transformers, safetensors, olmo_hils, text-generation, long-context, sparse-attention, efficient-attention, pretraining
