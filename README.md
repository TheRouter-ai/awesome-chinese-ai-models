...
- 2026-09-21 `open_source` [QwenLM/qwen-code release Release v0.24.3](https://github.com/QwenLM/qwen-code/releases/tag/v0.24.3) — <!-- qwen-release-notes:v2 -->  ## Highlights  _See the complete change list below._  ## Breaking Changes  No known breaking changes.  ## Web Shell  Web Shell gains structured shell results, optional trajectory metrics, host settings allowl
- 2026-09-21 `model_update` [Hugging Face model update: Qwen/Qwen-Image-2.1](https://huggingface.co/Qwen/Qwen-Image-2.1) — Model card/update on Hugging Face. Tags: diffusers, safetensors, qwen, image-generation, image-editing, rgba, text-to-image, license:other
- 2026-09-21 `open_source` [GitHub repository update: QwenLM/RecreationWorld](https://github.com/QwenLM/RecreationWorld) — Repository tracked from an official GitHub organization.
- 2026-09-21 `open_source` [GitHub repository update: QwenLM/Qwen-Live-Harness](https://github.com/QwenLM/Qwen-Live-Harness) — An open-source agent harness powered by the Qwen Omni Realtime API—see, hear, and act, with built-in memory.
- 2026-09-20 `model_update` [Hugging Face model update: Qwen/Qwen-Image-2.1-PE-T2I](https://huggingface.co/Qwen/Qwen-Image-2.1-PE-T2I) — Model card/update on Hugging Face. Tags: safetensors, qwen3_5, qwen, prompt-rewriting, text-to-image, license:other, region:us
- 2026-09-20 `model_update` [Hugging Face model update: Qwen/Qwen-Image-2.1-PE-I2I](https://huggingface.co/Qwen/Qwen-Image-2.1-PE-I2I) — Model card/update on Hugging Face. Tags: safetensors, qwen3_5, qwen, prompt-rewriting, image-editing, license:other, region:us
