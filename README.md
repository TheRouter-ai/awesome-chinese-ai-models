...
- 2026-05-26 `model_update` [Hugging Face model update: openbmb/MiniCPM5-1B](https://huggingface.co/openbmb/MiniCPM5-1B) — Model card/update on Hugging Face. Tags: transformers, safetensors, llama, text-generation, minicpm, minicpm5, long-context, tool-calling
- 2026-05-26 `open_source` [OpenBMB/MiniCPM release MiniCPM5-1B](https://github.com/OpenBMB/MiniCPM/releases/tag/5.0) — We are releasing **MiniCPM5-1B**, the first model in the **MiniCPM5** series. It is a dense 1B Transformer built for on-device, local deployment, and resource-constrained scenarios, reaching 1B-class open-source SOTA.    🏆 **1B-class open-s
- 2026-05-25 `open_source` [QwenLM/qwen-code release Release v0.16.1-nightly.20260525.84f408017](https://github.com/QwenLM/qwen-code/releases/tag/v0.16.1-nightly.20260525.84f408017) — <!-- Release notes generated using configuration in .github/release.yml at release/v0.16.1-nightly.20260525.84f408017 -->  ## What's Changed * fix(build): clean stale outputs before tsc --build to prevent TS5055 by @doudouOUC in https://git
- 2026-05-25 `model_update` [Hugging Face model update: openbmb/MiniCPM5-1B-SFT](https://huggingface.co/openbmb/MiniCPM5-1B-SFT) — Model card/update on Hugging Face. Tags: transformers, safetensors, llama, text-generation, minicpm, minicpm5, long-context, tool-calling
- 2026-05-25 `model_update` [Hugging Face model update: openbmb/MiniCPM5-1B-MLX](https://huggingface.co/openbmb/MiniCPM5-1B-MLX) — Model card/update on Hugging Face. Tags: transformers, safetensors, llama, text-generation, minicpm, minicpm5, long-context, tool-calling
- 2026-05-25 `model_update` [Hugging Face model update: openbmb/MiniCPM5-1B-GGUF](https://huggingface.co/openbmb/MiniCPM5-1B-GGUF) — Model card/update on Hugging Face. Tags: transformers, gguf, minicpm, minicpm5, llama, text-generation, long-context, tool-calling
- 2026-05-25 `open_source` [OpenBMB/MiniCPM-Desk-Pet release MiniCPM Desk Pet v0.7.1](https://github.com/OpenBMB/MiniCPM-Desk-Pet/releases/tag/v0.7.1) — # MiniCPM Desk Pet v0.7.1 — Release Notes    ---    ## 中文    ### MiniCPM Desk Pet — 首个公开发布    **MiniCPM Desk Pet** 是一款本地优先的桌面 AI 桌宠。安装后跟随首次启动引导完成设置，即可在桌面上与 MiniCPM 聊天，并在你使用 Cursor、Claude Code、Codex 等 coding agent 时展示不同状态。    ### 主要功能    - *
- 2026-05-25 `model_update` [Hugging Face model update: internlm/CapRL-Video-4B](https://huggingface.co/internlm/CapRL-Video-4B) — Model card/update on Hugging Face. Tags: safetensors, qwen3_vl, license:apache-2.0, region:us
- 2026-05-25 `open_source` [GitHub repository update: OpenBMB/MiniCPM-Desk-Pet](https://github.com/OpenBMB/MiniCPM-Desk-Pet) — a local-first desktop pet powered by MiniCPM5-0.9B
