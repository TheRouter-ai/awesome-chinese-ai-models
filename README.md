...
- 2026-05-29 `open_source` [GitHub repository update: QwenLM/Qwen-VLA](https://github.com/QwenLM/Qwen-VLA) — Repository tracked from an official GitHub organization.
- 2026-05-28 `model_update` [Hugging Face model update: Qwen/Qwen-Image-Bench](https://huggingface.co/Qwen/Qwen-Image-Bench) — Model card/update on Hugging Face. Tags: transformers, safetensors, qwen3_5, image-text-to-text, judge-model, text-to-image, evaluation, benchmark
- 2026-05-28 `open_source` [OpenBMB/MiniCPM-Desk-Pet release MiniCPM Desk Pet v0.7.3](https://github.com/OpenBMB/MiniCPM-Desk-Pet/releases/tag/v0.7.3) — # MiniCPM Desk Pet v0.7.3 — Release Notes    ## 中文    ### 概述    v0.7.3 是一次稳定性与发布链路维护版本，重点修复 Windows 启动与 sidecar 生命周期问题，并切换后端到 llama.cpp 主线。    ### 问题修复    - 修复部分环境下 permission bubble 定位时 pet bounds 为空导致的崩溃。  - 修复系统配置 SOCKS/HTTP 代理时 sidecar
