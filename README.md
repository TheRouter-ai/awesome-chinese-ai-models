...
- 2026-06-02 `model_update` [Hugging Face model update: openbmb/MiniCPM-V-4-gguf](https://huggingface.co/openbmb/MiniCPM-V-4-gguf) — Model card/update on Hugging Face. Tags: transformers, gguf, minicpm-v, vision, ocr, multi-image, video, custom_code
- 2026-06-02 `model_update` [Hugging Face model update: openbmb/MiniCPM-V-4-AWQ](https://huggingface.co/openbmb/MiniCPM-V-4-AWQ) — Model card/update on Hugging Face. Tags: transformers, safetensors, minicpmv, feature-extraction, minicpm-v, vision, ocr, multi-image
