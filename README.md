...
- 2026-09-01 `open_source` [QwenLM/qwen-code release cua-driver-rs v0.20.3](https://github.com/QwenLM/qwen-code/releases/tag/cua-driver-rs-v0.20.3) — Qwen CUA Driver prebuilt binaries (vendored under `packages/cua-driver`).  - **macOS**: codesigned + notarized universal binary + `QwenCuaDriver.app` - **Linux**: unsigned (x86_64 + arm64, glibc 2.31 floor) - **Windows**: unsigned UIAccess
- 2026-09-01 `open_source` [InternLM/lmdeploy release v0.17.0](https://github.com/InternLM/lmdeploy/releases/tag/v0.17.0) — <!-- Release notes generated using configuration in .github/release.yml at main -->    ## What's Changed  ### 🚀 Features  * Integrate DeepEPv2 by @irexyc in https://github.com/InternLM/lmdeploy/pull/4783  * feat(pytorch): support Kimi K2.6
...
- 2026-09-01 `open_source` [GitHub repository update: QwenLM/E-CommerceBench](https://github.com/QwenLM/E-CommerceBench) — Repository tracked from an official GitHub organization.
