...
- 2026-08-19 `model_update` [Hugging Face model update: openbmb/Ultra-FineWeb-classifier](https://huggingface.co/openbmb/Ultra-FineWeb-classifier) — Model card/update on Hugging Face. Tags: arxiv:2505.05427, arxiv:2602.09003, license:apache-2.0, region:us
- 2026-08-19 `open_source` [InternLM/lmdeploy release v0.16.0](https://github.com/InternLM/lmdeploy/releases/tag/v0.16.0) — <!-- Release notes generated using configuration in .github/release.yml at main -->    ## What's Changed  ### 🚀 Features  * Support Interns2 mobius by @RunningLeon in https://github.com/InternLM/lmdeploy/pull/4816  * feat: support GLM-5.2 b
