...
- 2026-05-25 `open_source` [GitHub repository update: OpenBMB/ChatDev](https://github.com/OpenBMB/ChatDev) — ChatDev 2.0: Dev All through LLM-powered Multi-Agent Collaboration
- 2026-05-25 `open_source` [GitHub repository update: InternLM/ETCHR](https://github.com/InternLM/ETCHR) — Repository tracked from an official GitHub organization.
- 2026-05-25 `open_source` [GitHub repository update: InternLM/CapRL](https://github.com/InternLM/CapRL) — [ICLR 2026] An official implementation of "CapRL: Stimulating Dense Image Caption Capabilities via Reinforcement Learning"
...
- 2026-05-24 `model_update` [Hugging Face model update: openbmb/BitCPM-CANN-8B](https://huggingface.co/openbmb/BitCPM-CANN-8B) — Model card/update on Hugging Face. Tags: transformers, pytorch, minicpm, text-generation, conversational, custom_code, zh, en
