...
- 2026-06-26 `open_source` [QwenLM/qwen-code release cua-driver-rs v0.6.8](https://github.com/QwenLM/qwen-code/releases/tag/cua-driver-rs-v0.6.8) — cua-driver prebuilt binaries — relative-coordinate fork (vendored under `packages/cua-driver`).  - **macOS**: codesigned + notarized universal binary + `QwenCuaDriver.app` - **Linux**: unsigned (x86_64 + arm64, glibc 2.31 floor) - **Windows
- 2026-06-26 `model_update` [Hugging Face model update: Qwen/Qwen3-ForcedAligner-0.6B-hf](https://huggingface.co/Qwen/Qwen3-ForcedAligner-0.6B-hf) — Model card/update on Hugging Face. Tags: transformers, safetensors, qwen3_asr, token-classification, zh, en, yue, fr
- 2026-06-26 `model_update` [Hugging Face model update: Qwen/Qwen3-ASR-1.7B-hf](https://huggingface.co/Qwen/Qwen3-ASR-1.7B-hf) — Model card/update on Hugging Face. Tags: transformers, safetensors, qwen3_asr, automatic-speech-recognition, zh, en, yue, ar
- 2026-06-26 `model_update` [Hugging Face model update: Qwen/Qwen3-ASR-0.6B-hf](https://huggingface.co/Qwen/Qwen3-ASR-0.6B-hf) — Model card/update on Hugging Face. Tags: transformers, safetensors, qwen3_asr, automatic-speech-recognition, zh, en, yue, ar
- 2026-06-26 `open_source` [GitHub repository update: QwenLM/Qwen3-ASR](https://github.com/QwenLM/Qwen3-ASR) — Qwen3-ASR is an open-source series of ASR models developed by the Qwen team at Alibaba Cloud, supporting stable multilingual speech/music/song recognition, language detection and timestamp prediction.
