...
- 2026-08-03 `open_source` [QwenLM/qwen-code release Release v0.21.4](https://github.com/QwenLM/qwen-code/releases/tag/v0.21.4) — <!-- qwen-release-notes:v1 -->  ## Highlights  - Web Shell is now a release-ready desktop app with native lifecycle management, single-instance behavior, and automatic updates. ([#8132](https://github.com/QwenLM/qwen-code/pull/8132)) - Web
- 2026-08-03 `model_update` [Hugging Face model update: openbmb/MiniCPM-V-4.6-Thinking](https://huggingface.co/openbmb/MiniCPM-V-4.6-Thinking) — Model card/update on Hugging Face. Tags: transformers, safetensors, minicpmv4_6, image-text-to-text, minicpm-v, multimodal, On-Device Model, lightweight
- 2026-08-03 `model_update` [Hugging Face model update: openbmb/MiniCPM-o-4_5-GPTQ](https://huggingface.co/openbmb/MiniCPM-o-4_5-GPTQ) — Model card/update on Hugging Face. Tags: transformers, onnx, safetensors, minicpmo, feature-extraction, minicpm-o, minicpm-v, multimodal
- 2026-08-03 `model_update` [Hugging Face model update: openbmb/MiniCPM-o-4_5-gguf](https://huggingface.co/openbmb/MiniCPM-o-4_5-gguf) — Model card/update on Hugging Face. Tags: transformers, gguf, minicpm-o, minicpm-v, multimodal, full-duplex, any-to-any, arxiv:2408.01800
- 2026-08-03 `model_update` [Hugging Face model update: openbmb/MiniCPM-o-4_5-awq](https://huggingface.co/openbmb/MiniCPM-o-4_5-awq) — Model card/update on Hugging Face. Tags: transformers, onnx, safetensors, minicpmo, feature-extraction, minicpm-o, minicpm-v, multimodal
- 2026-08-03 `open_source` [GitHub repository update: OpenBMB/ForgeStencil](https://github.com/OpenBMB/ForgeStencil) — Repository tracked from an official GitHub organization.
