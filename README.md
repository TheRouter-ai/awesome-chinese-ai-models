...
- 2026-09-16 `model_update` [Hugging Face model update: BAAI/Brainmu-Spike](https://huggingface.co/BAAI/Brainmu-Spike) — Model card/update on Hugging Face. Tags: safetensors, spike-camera, image-reconstruction, lora, zh, license:apache-2.0, region:us
