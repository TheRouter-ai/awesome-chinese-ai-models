...
- 2026-08-28 `open_source` [GitHub repository update: OpenBMB/SimpleNav](https://github.com/OpenBMB/SimpleNav) — SimpleNav: A simple, unified, reproducible, and extensible framework for navigation VLA research.
