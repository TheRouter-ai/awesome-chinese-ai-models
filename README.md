...
- 2026-08-13 `model_update` [Hugging Face model update: openbmb/MiniCPM-V-4_5-int4](https://huggingface.co/openbmb/MiniCPM-V-4_5-int4) — Model card/update on Hugging Face. Tags: transformers, safetensors, minicpm-v, vision, ocr, multi-image, video, custom_code
- 2026-08-13 `open_source` [GitHub repository update: deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) — DeepSeek Harness: Everything is a Plugin.
- 2026-08-13 `model_update` [Hugging Face model update: deepseek-ai/DeepSeek-V4-Pro-0813](https://huggingface.co/deepseek-ai/DeepSeek-V4-Pro-0813) — Model card/update on Hugging Face. Tags: transformers, safetensors, deepseek_v4, text-generation, conversational, arxiv:2606.19348, license:mit, endpoints_compatible
