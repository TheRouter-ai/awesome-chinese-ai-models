...
- 2026-06-23 `open_source` [OpenBMB/PilotDeck release PilotDeck Desktop 260623](https://github.com/OpenBMB/PilotDeck/releases/tag/v260623) — # PilotDeck Desktop 260623    Release date: 2026.06.23    This release updates PilotDeck Desktop to build `260623` (`0.1.260623`). Compared with `v0.1.0`, this version focuses on stability, IM channels, frontend experience, and Cron / Alway
- 2026-06-23 `open_source` [GitHub repository update: QwenLM/Confident-Decoding](https://github.com/QwenLM/Confident-Decoding) — Repository tracked from an official GitHub organization.
- 2026-06-23 `open_source` [GitHub repository update: OpenBMB/SHIFT](https://github.com/OpenBMB/SHIFT) — Souce code for paper "SHIFT: Gate-Modulated Activation Steering for Knowledge Conflict Mitigation in Retrieval-Augmented Generation"
