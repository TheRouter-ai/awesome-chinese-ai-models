...
- 2026-08-12 `model_update` [Hugging Face model update: Qwen/Qwen3.8-2.4T-A95B-FP8](https://huggingface.co/Qwen/Qwen3.8-2.4T-A95B-FP8) — Model card/update on Hugging Face. Tags: transformers, safetensors, qwen3_5_moe_text, text-generation, conversational, base_model:Qwen/Qwen3.8-2.4T-A95B, base_model:quantized:Qwen/Qwen3.8-2.4T-A95B, license:other
- 2026-08-12 `model_update` [Hugging Face model update: Qwen/Qwen3.8-2.4T-A95B](https://huggingface.co/Qwen/Qwen3.8-2.4T-A95B) — Model card/update on Hugging Face. Tags: transformers, safetensors, qwen3_5_moe_text, text-generation, conversational, license:other, eval-results, endpoints_compatible
...
- 2026-08-11 `model_update` [Hugging Face model update: BAAI/AREX-Turbo](https://huggingface.co/BAAI/AREX-Turbo) — Model card/update on Hugging Face. Tags: transformers, safetensors, qwen3_5, image-text-to-text, agent, deep-research, reasoning, tool-use
- 2026-08-11 `model_update` [Hugging Face model update: BAAI/AREX-Base](https://huggingface.co/BAAI/AREX-Base) — Model card/update on Hugging Face. Tags: transformers, safetensors, qwen3_5_moe, image-text-to-text, agent, deep-research, reasoning, tool-use
