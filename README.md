...
- 2026-06-04 `model_update` [Hugging Face model update: openbmb/SciCore-Omics](https://huggingface.co/openbmb/SciCore-Omics) — Model card/update on Hugging Face. Tags: transformers, safetensors, minicpmv, feature-extraction, histopathology, multimodal, spatial-transcriptomics, custom_code
- 2026-06-04 `model_update` [Hugging Face model update: openbmb/MiniCPM-V-2_6-GPTQ](https://huggingface.co/openbmb/MiniCPM-V-2_6-GPTQ) — Model card/update on Hugging Face. Tags: transformers, safetensors, minicpmv, feature-extraction, minicpm-v, vision, ocr, multi-image
- 2026-06-04 `model_update` [Hugging Face model update: openbmb/MiniCPM-Llama3-V-2_5-GPTQ](https://huggingface.co/openbmb/MiniCPM-Llama3-V-2_5-GPTQ) — Model card/update on Hugging Face. Tags: transformers, safetensors, minicpmv, feature-extraction, minicpm-v, vision, ocr, custom_code
- 2026-06-03 `open_source` [QwenLM/qwen-code release Release v0.17.1](https://github.com/QwenLM/qwen-code/releases/tag/v0.17.1) — <!-- Release notes generated using configuration in .github/release.yml at release/v0.17.1 -->  ## What's Changed * chore(release): v0.17.0 by @qwen-code-ci-bot in https://github.com/QwenLM/qwen-code/pull/4626 * fix(rewind): false "compress
