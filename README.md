...
- 2026-07-13 `model_update` [Hugging Face model update: BAAI/AquilaSQL-7B](https://huggingface.co/BAAI/AquilaSQL-7B) — Model card/update on Hugging Face. Tags: transformers, pytorch, aquila, custom_code, license:other, endpoints_compatible, region:us
- 2026-07-13 `model_update` [Hugging Face model update: BAAI/AquilaCode-multi](https://huggingface.co/BAAI/AquilaCode-multi) — Model card/update on Hugging Face. Tags: transformers, pytorch, aquila, custom_code, license:other, endpoints_compatible, region:us
- 2026-07-13 `model_update` [Hugging Face model update: BAAI/AquilaChat2-70B-Expr](https://huggingface.co/BAAI/AquilaChat2-70B-Expr) — Model card/update on Hugging Face. Tags: transformers, pytorch, aquila, text-generation, license:other, endpoints_compatible, region:us
- 2026-07-13 `model_update` [Hugging Face model update: BAAI/AquilaChat-7B](https://huggingface.co/BAAI/AquilaChat-7B) — Model card/update on Hugging Face. Tags: transformers, pytorch, aquila, custom_code, license:other, endpoints_compatible, region:us
- 2026-07-13 `model_update` [Hugging Face model update: BAAI/Aquila-7B](https://huggingface.co/BAAI/Aquila-7B) — Model card/update on Hugging Face. Tags: transformers, pytorch, aquila, custom_code, license:other, endpoints_compatible, region:us
- 2026-07-12 `model_update` [Hugging Face model update: openbmb/UltraX-0.6B-Preview](https://huggingface.co/openbmb/UltraX-0.6B-Preview) — Model card/update on Hugging Face. Tags: safetensors, data-refinement, function-calling, programmatic-editing, pretraining, text-generation, en, arxiv:2607.08646
