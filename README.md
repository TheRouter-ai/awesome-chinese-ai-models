...
- 2026-07-10 `open_source` [QwenLM/qwen-code release Release v0.19.8-nightly.20260710.205430235](https://github.com/QwenLM/qwen-code/releases/tag/v0.19.8-nightly.20260710.205430235) — <!-- Release notes generated using configuration in .github/release.yml at release/v0.19.8-nightly.20260710.205430235 -->  ## What's Changed * Stop repeated subagent tool-call loops by @yiliang114 in https://github.com/QwenLM/qwen-code/pull
- 2026-07-10 `open_source` [QwenLM/qwen-code release PR #6633 Screenshots](https://github.com/QwenLM/qwen-code/releases/tag/pr6633-screenshots) — Screenshots for PR #6633 verification
- 2026-07-09 `open_source` [QwenLM/qwen-code release cua-driver-rs v0.7.1](https://github.com/QwenLM/qwen-code/releases/tag/cua-driver-rs-v0.7.1) — cua-driver prebuilt binaries — relative-coordinate fork (vendored under `packages/cua-driver`).  - **macOS**: codesigned + notarized universal binary + `QwenCuaDriver.app` - **Linux**: unsigned (x86_64 + arm64, glibc 2.31 floor) - **Windows
- 2026-07-09 `open_source` [GitHub repository update: QwenLM/qwen-code-action](https://github.com/QwenLM/qwen-code-action) — A GitHub Action that integrates Qwen Code into your development workflow.
- 2026-07-08 `model_update` [Hugging Face model update: tencent/R3-rerank-0.6b](https://huggingface.co/tencent/R3-rerank-0.6b) — Model card/update on Hugging Face. Tags: safetensors, qwen3, cross-encoder, agent-skill-retrieval, text-ranking, arxiv:2606.03565, base_model:Qwen/Qwen3-Reranker-0.6B, base_model:finetune:Qwen/Qwen3-Reranker-0.6B
- 2026-07-08 `model_update` [Hugging Face model update: tencent/R3-embedding-0.6b](https://huggingface.co/tencent/R3-embedding-0.6b) — Model card/update on Hugging Face. Tags: sentence-transformers, safetensors, qwen3, feature-extraction, agent-skill-retrieval, sentence-similarity, arxiv:2606.03565, base_model:Qwen/Qwen3-Embedding-0.6B
- 2026-07-08 `open_source` [QwenLM/qwen-code release Release v0.19.8](https://github.com/QwenLM/qwen-code/releases/tag/v0.19.8) — <!-- Release notes generated using configuration in .github/release.yml at release/v0.19.8 -->  ## What's Changed * docs(channels): add WeCom to channels overview by @DragonnZhang in https://github.com/QwenLM/qwen-code/pull/6490 * feat(cli)
