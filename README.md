...
- 2026-06-03 `model_update` [Hugging Face model update: openbmb/MiniCPM-o-2_6-GPTQ](https://huggingface.co/openbmb/MiniCPM-o-2_6-GPTQ) — Model card/update on Hugging Face. Tags: transformers, safetensors, minicpmo, feature-extraction, minicpm-o, omni, vision, ocr
- 2026-06-03 `open_source` [GitHub repository update: InternLM/OVO-S-Bench](https://github.com/InternLM/OVO-S-Bench) — Repository tracked from an official GitHub organization.
...
- 2026-06-02 `model_update` [Hugging Face model update: openbmb/MiniCPM-V-4-GPTQ](https://huggingface.co/openbmb/MiniCPM-V-4-GPTQ) — Model card/update on Hugging Face. Tags: transformers, safetensors, minicpmv, feature-extraction, minicpm-v, vision, ocr, multi-image
