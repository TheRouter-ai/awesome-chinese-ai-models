...
- 2026-09-10 `open_source` [QwenLM/qwen-code release Qwen Code Desktop v0.3.0-preview.0](https://github.com/QwenLM/qwen-code/releases/tag/desktop-v0.3.0-preview.0) — <!-- Release notes generated using configuration in .github/release.yml at ad92d2bf8f1cea911213493121d2b3fb571ba80e -->  ## What's Changed * test(channels): canonicalize restored worktree fixture paths by @yiliang114 in https://github.com/Q
- 2026-09-10 `model_update` [Hugging Face model update: deepseek-ai/DeepSeek-V4.1-Flash](https://huggingface.co/deepseek-ai/DeepSeek-V4.1-Flash) — Model card/update on Hugging Face. Tags: transformers, safetensors, deepseek_v41, text-generation, license:mit, endpoints_compatible, 8-bit, fp8
- 2026-09-10 `open_source` [deepseek-ai/deepseek-harness release v0.1.5-rc.1](https://github.com/deepseek-ai/deepseek-harness/releases/tag/dsh-v0.1.5-rc.1) — [中文](#cn-v0.1.5-rc.1) | [English](#en-v0.1.5-rc.1)    作为 `0.1.5` 系列的首个候选版本，本版本汇总了自 `v0.1.2-rc.1` 以来的主要用户和开发者相关变更。    <h3 id="cn-v0.1.5-rc.1">新增功能</h3>    - DeepSeek 模型适配器新增 `DeepSeek-V41-Flash`（`deepseek-flash`）支持文本、图片及会话历史中的系统提示词更新。新会话默认使用
- 2026-09-10 `model_update` [Hugging Face model update: BAAI/AIDD](https://huggingface.co/BAAI/AIDD) — Model card/update on Hugging Face. Tags: license:cc-by-4.0, region:us
- 2026-09-09 `model_update` [Hugging Face model update: tencent/AuK-Flash](https://huggingface.co/tencent/AuK-Flash) — Model card/update on Hugging Face. Tags: speech, text-to-speech, zero-shot-tts, voice-cloning, speech-generation, speech-editing, speech-enhancement, source-separation
- 2026-09-09 `model_update` [Hugging Face model update: tencent/AuK](https://huggingface.co/tencent/AuK) — Model card/update on Hugging Face. Tags: audio, speech, text-to-speech, zero-shot-tts, voice-cloning, speech-generation, speech-editing, speech-enhancement
- 2026-09-09 `open_source` [QwenLM/qwen-code release Release v0.23.2-nightly.20260909.2e212144d3](https://github.com/QwenLM/qwen-code/releases/tag/v0.23.2-nightly.20260909.2e212144d3) — <!-- Release notes generated using configuration in .github/release.yml at release/v0.23.2-nightly.20260909.2e212144d3 -->  ## What's Changed * fix(goal): retry a checkpoint that overran the claim budget instead of spending a stall by @qqqy
- 2026-09-09 `open_source` [QwenLM/qwen-code release Release v0.23.2](https://github.com/QwenLM/qwen-code/releases/tag/v0.23.2) — <!-- qwen-release-notes:v1 -->  ## Highlights  _See the complete change list below._  ## Breaking Changes  No known breaking changes.  ## Complete Change List  ### Features  - feat(web-shell): Improve split-view session navigation ([#11250]
- 2026-09-09 `model_update` [Hugging Face model update: openbmb/MiniCPM5-2B-Base](https://huggingface.co/openbmb/MiniCPM5-2B-Base) — Model card/update on Hugging Face. Tags: transformers, safetensors, llama, text-generation, minicpm, minicpm5, long-context, tool-calling
- 2026-09-09 `model_update` [Hugging Face model update: openbmb/MiniCPM5-2B](https://huggingface.co/openbmb/MiniCPM5-2B) — Model card/update on Hugging Face. Tags: transformers, safetensors, llama, text-generation, minicpm, minicpm5, long-context, tool-calling
