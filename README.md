...
- 2026-08-10 `open_source` [GitHub repository update: Tencent-Hunyuan/Hunyuan3D-WorldClaw](https://github.com/Tencent-Hunyuan/Hunyuan3D-WorldClaw) — Repository tracked from an official GitHub organization.
- 2026-08-06 `model_update` [Hugging Face model update: internlm/Intern-S1-FP8](https://huggingface.co/internlm/Intern-S1-FP8) — Model card/update on Hugging Face. Tags: safetensors, interns1, image-text-to-text, conversational, custom_code, arxiv:2508.15763, base_model:internlm/Intern-S1, base_model:quantized:internlm/Intern-S1
- 2026-08-06 `model_update` [Hugging Face model update: internlm/Intern-MemDec-4B](https://huggingface.co/internlm/Intern-MemDec-4B) — Model card/update on Hugging Face. Tags: safetensors, qwen3_5, intern-s2, memory-decoder, biology, scientific-ai, domain-adaptation, arxiv:2607.25614
- 2026-08-05 `open_source` [QwenLM/qwen-code release Release v0.21.5-nightly.20260805.32e274157](https://github.com/QwenLM/qwen-code/releases/tag/v0.21.5-nightly.20260805.32e274157) — <!-- Release notes generated using configuration in .github/release.yml at release/v0.21.5-nightly.20260805.32e274157 -->  ## What's Changed * feat(browser-ext): add alpha readiness diagnostics by @yiliang114 in https://github.com/QwenLM/qw
...
- 2026-08-05 `model_update` [Hugging Face model update: internlm/Intern-S2-Mobius-FP8](https://huggingface.co/internlm/Intern-S2-Mobius-FP8) — Model card/update on Hugging Face. Tags: transformers, safetensors, interns2_mobius, image-text-to-text, conversational, custom_code, license:apache-2.0, fp8
