...
- 2026-09-03 `model_update` [Hugging Face model update: BAAI/Recon2Reason-Reasoning-4B](https://huggingface.co/BAAI/Recon2Reason-Reasoning-4B) — Model card/update on Hugging Face. Tags: transformers, safetensors, qwen3_vl, image-text-to-text, qwen3-vl, vision-language, spatial-reasoning, spatial-understanding
- 2026-09-03 `model_update` [Hugging Face model update: BAAI/MobileVLA-R1](https://huggingface.co/BAAI/MobileVLA-R1) — Model card/update on Hugging Face. Tags: license:cc-by-sa-4.0, region:us
