...
- 2026-08-31 `model_update` [Hugging Face model update: tencent/ContextPilot-E4B](https://huggingface.co/tencent/ContextPilot-E4B) — Model card/update on Hugging Face. Tags: transformers, safetensors, gemma4, image-text-to-text, context-management, tool-use, agent, text-generation
- 2026-08-31 `model_update` [Hugging Face model update: tencent/ContextPilot-8B](https://huggingface.co/tencent/ContextPilot-8B) — Model card/update on Hugging Face. Tags: transformers, safetensors, qwen3, text-generation, context-management, tool-use, agent, conversational
- 2026-08-31 `model_update` [Hugging Face model update: tencent/ContextPilot-14B](https://huggingface.co/tencent/ContextPilot-14B) — Model card/update on Hugging Face. Tags: transformers, safetensors, qwen3, text-generation, context-management, tool-use, agent, conversational
- 2026-08-30 `open_source` [deepseek-ai/deepseek-harness release v0.1.2-alpha.2](https://github.com/deepseek-ai/deepseek-harness/releases/tag/dsh-v0.1.2-alpha.2) — [中文](#cn-v0.1.2-alpha.2) | [English](#en-v0.1.2-alpha.2)    <h3 id="cn-v0.1.2-alpha.2">新增功能</h3>    * 界面新增显示连接异常状态，支持自动重试和立即重连 @imccyu  * 会话标题区域支持查看活动的定时计划 @pku-xht    <h3>体验优化</h3>    * 插件列表按会话插件和全局插件分组，可切换 Agent Preset 查看组合、搜索其他预设 @LegGas
- 2026-08-29 `open_source` [QwenLM/qwen-code release Release v0.22.3-nightly.20260829.e5cb60ad48](https://github.com/QwenLM/qwen-code/releases/tag/v0.22.3-nightly.20260829.e5cb60ad48) — <!-- Release notes generated using configuration in .github/release.yml at release/v0.22.3-nightly.20260829.e5cb60ad48 -->  ## What's Changed * feat(web-shell): show git state hints beside branch picker actions by @wenshao in https://github
- 2026-08-28 `model_update` [Hugging Face model update: tencent/Hy4-preview-FP8](https://huggingface.co/tencent/Hy4-preview-FP8) — Model card/update on Hugging Face. Tags: transformers, safetensors, hy_v4, text-generation, hunyuan, hy4, moe, fp8
- 2026-08-28 `model_update` [Hugging Face model update: tencent/Hy4-preview](https://huggingface.co/tencent/Hy4-preview) — Model card/update on Hugging Face. Tags: transformers, safetensors, hy_v4, text-generation, hunyuan, hy4, moe, conversational
- 2026-08-28 `open_source` [QwenLM/qwen-code release Release v0.22.3](https://github.com/QwenLM/qwen-code/releases/tag/v0.22.3) — <!-- qwen-release-notes:v1 -->  ## Highlights  - Added owner-scoped named sessions in Channels to manage up to eight persistent tasks per chat. ([#10198](https://github.com/QwenLM/qwen-code/pull/10198)) - Enabled daemon Extension installs t
...
- 2026-08-28 `open_source` [GitHub repository update: Tencent-Hunyuan/Hy4-preview](https://github.com/Tencent-Hunyuan/Hy4-preview) — Repository tracked from an official GitHub organization.
