...
- 2026-05-29 `open_source` [GitHub repository update: OpenBMB/UltraRAG](https://github.com/OpenBMB/UltraRAG) — A Low-Code MCP Framework for Building Complex and Innovative RAG Pipelines
