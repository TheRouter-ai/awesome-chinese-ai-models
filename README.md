...
- 2026-09-08 `model_update` [Hugging Face model update: openbmb/MiniCPM5-2B-SFT](https://huggingface.co/openbmb/MiniCPM5-2B-SFT) — Model card/update on Hugging Face. Tags: transformers, safetensors, llama, text-generation, minicpm, minicpm5, long-context, tool-calling
- 2026-09-08 `model_update` [Hugging Face model update: openbmb/MiniCPM5-2B-MLX](https://huggingface.co/openbmb/MiniCPM5-2B-MLX) — Model card/update on Hugging Face. Tags: transformers, safetensors, llama, text-generation, minicpm, minicpm5, long-context, tool-calling
- 2026-09-08 `model_update` [Hugging Face model update: openbmb/MiniCPM5-2B-Midtrain](https://huggingface.co/openbmb/MiniCPM5-2B-Midtrain) — Model card/update on Hugging Face. Tags: transformers, safetensors, llama, text-generation, minicpm, minicpm5, long-context, tool-calling
- 2026-09-08 `model_update` [Hugging Face model update: openbmb/MiniCPM5-2B-GPTQ](https://huggingface.co/openbmb/MiniCPM5-2B-GPTQ) — Model card/update on Hugging Face. Tags: transformers, safetensors, llama, text-generation, minicpm, minicpm5, long-context, tool-calling
