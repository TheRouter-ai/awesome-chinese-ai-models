...
- 2026-06-16 `open_source` [InternLM/lmdeploy release v0.14.0a2](https://github.com/InternLM/lmdeploy/releases/tag/0.14.0a2) — <!-- Release notes generated using configuration in .github/release.yml at main -->    ## What's Changed  ### 🚀 Features  * FP8 kv cache quantization by @CUHKSZzxy in https://github.com/InternLM/lmdeploy/pull/4563  * Support Qwen3 Omni by @
- 2026-06-15 `model_update` [Hugging Face model update: tencent/Hy-Embodied-0.5-VLA-UMI](https://huggingface.co/tencent/Hy-Embodied-0.5-VLA-UMI) — Model card/update on Hugging Face. Tags: safetensors, robotics, VLA, bimanual, UMI, imitation-learning, pre-trained, arxiv:2606.14409
- 2026-06-15 `model_update` [Hugging Face model update: tencent/Hy-Embodied-0.5-VLA-RoboTwin](https://huggingface.co/tencent/Hy-Embodied-0.5-VLA-RoboTwin) — Model card/update on Hugging Face. Tags: safetensors, robotics, VLA, bimanual, RoboTwin, imitation-learning, fine-tuned, arxiv:2606.14409
- 2026-06-15 `open_source` [QwenLM/qwen-code release Release v0.18.1](https://github.com/QwenLM/qwen-code/releases/tag/v0.18.1) — <!-- Release notes generated using configuration in .github/release.yml at release/v0.18.1 -->  ## What's Changed * chore(release): v0.18.0 by @qwen-code-ci-bot in https://github.com/QwenLM/qwen-code/pull/5050 * feat(daemon): gate direct se
...
- 2026-06-15 `open_source` [GitHub repository update: Tencent-Hunyuan/HY-Embodied](https://github.com/Tencent-Hunyuan/HY-Embodied) — HY-Embodied: Embodied Foundation Models for Real-World Agents
- 2026-06-15 `open_source` [GitHub repository update: Tencent-Hunyuan/Hy-Embodied-0.5-VLA](https://github.com/Tencent-Hunyuan/Hy-Embodied-0.5-VLA) — From Vision-Language-Action Models to a Real-World Robot Learning Stack
