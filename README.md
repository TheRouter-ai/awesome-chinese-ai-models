...
- 2026-05-24 `open_source` [QwenLM/qwen-code release Release v0.16.1-nightly.20260524.84f408017](https://github.com/QwenLM/qwen-code/releases/tag/v0.16.1-nightly.20260524.84f408017) — <!-- Release notes generated using configuration in .github/release.yml at release/v0.16.1-nightly.20260524.84f408017 -->  ## What's Changed * fix(build): clean stale outputs before tsc --build to prevent TS5055 by @doudouOUC in https://git
- 2026-05-24 `open_source` [OpenBMB/ArcLight release v1.1](https://github.com/OpenBMB/ArcLight/releases/tag/v1.1) — We release v1.1 in which x86 and WIN32 app is supported!
- 2026-05-24 `open_source` [GitHub repository update: OpenBMB/ArcLight](https://github.com/OpenBMB/ArcLight) — ArcLight: A Lightweight LLM Inference Framework
- 2026-05-23 `open_source` [QwenLM/qwen-code release Release v0.16.1](https://github.com/QwenLM/qwen-code/releases/tag/v0.16.1) — <!-- Release notes generated using configuration in .github/release.yml at release/v0.16.1 -->  ## What's Changed * chore(release): v0.16.0 by @yiliang114 in https://github.com/QwenLM/qwen-code/pull/4404 * fix(core,cli): close tool_use↔tool
- 2026-05-23 `model_update` [Hugging Face model update: openbmb/BitCPM-CANN-8B-unquantized](https://huggingface.co/openbmb/BitCPM-CANN-8B-unquantized) — Model card/update on Hugging Face. Tags: transformers, pytorch, minicpm, text-generation, conversational, custom_code, zh, en
- 2026-05-23 `model_update` [Hugging Face model update: openbmb/BitCPM-CANN-8B](https://huggingface.co/openbmb/BitCPM-CANN-8B) — Model card/update on Hugging Face. Tags: transformers, pytorch, minicpm, text-generation, conversational, custom_code, zh, en
- 2026-05-23 `model_update` [Hugging Face model update: openbmb/BitCPM-CANN-3B-unquantized](https://huggingface.co/openbmb/BitCPM-CANN-3B-unquantized) — Model card/update on Hugging Face. Tags: transformers, pytorch, llama, text-generation, conversational, custom_code, zh, en
- 2026-05-23 `model_update` [Hugging Face model update: openbmb/BitCPM-CANN-1B-unquantized](https://huggingface.co/openbmb/BitCPM-CANN-1B-unquantized) — Model card/update on Hugging Face. Tags: transformers, pytorch, llama, text-generation, conversational, custom_code, zh, en
- 2026-05-23 `model_update` [Hugging Face model update: openbmb/BitCPM-CANN-0.5B-unquantized](https://huggingface.co/openbmb/BitCPM-CANN-0.5B-unquantized) — Model card/update on Hugging Face. Tags: transformers, pytorch, text-generation, conversational, custom_code, zh, en, license:apache-2.0
- 2026-05-23 `open_source` [GitHub repository update: OpenBMB/UltraRAG](https://github.com/OpenBMB/UltraRAG) — A Low-Code MCP Framework for Building Complex and Innovative RAG Pipelines
