...
- 2026-09-20 `open_source` [GitHub repository update: QwenLM/qwen-mm-plugins-hub](https://github.com/QwenLM/qwen-mm-plugins-hub) — A documentation for Qwen-MM-Plugins
- 2026-09-19 `open_source` [QwenLM/qwen-code release SDK TypeScript Release v0.1.13](https://github.com/QwenLM/qwen-code/releases/tag/sdk-typescript-v0.1.13) — ## Bundled CLI Version  This SDK release bundles CLI version: 0.24.1  Source: CLI built from source (same branch/ref as SDK)  ---  ## Bundled CLI Version  This SDK release bundles CLI version: 0.23.3  Source: CLI built from source (same bra
- 2026-09-19 `open_source` [QwenLM/qwen-code release Release v0.24.1](https://github.com/QwenLM/qwen-code/releases/tag/v0.24.1) — <!-- qwen-release-notes:v1 -->  ## Highlights  _See the complete change list below._  ## Breaking Changes  - refactor(goal)!: stop emitting the active_goal stream event ([#12181](https://github.com/QwenLM/qwen-code/pull/12181)) by @qqqys  #
