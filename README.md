...
- 2026-05-27 `open_source` [GitHub repository update: OpenBMB/PilotDeck](https://github.com/OpenBMB/PilotDeck) — Task-oriented AI Agent productivity platform
- 2026-05-27 `open_source` [GitHub repository update: InternLM/Skill-as-Pseudocode](https://github.com/InternLM/Skill-as-Pseudocode) — Skill-as-Pseudocode: refactoring markdown skill libraries into typed pseudocode contracts for LLM agents.
- 2026-05-26 `model_update` [Hugging Face model update: tencent/Hy-MT2-1.8B-GGUF](https://huggingface.co/tencent/Hy-MT2-1.8B-GGUF) — Model card/update on Hugging Face. Tags: gguf, arxiv:2605.22064, base_model:tencent/Hy-MT2-1.8B, base_model:quantized:tencent/Hy-MT2-1.8B, license:apache-2.0, endpoints_compatible, region:us, conversational
- 2026-05-26 `model_update` [Hugging Face model update: tencent/Hy-MT2-1.8B-2Bit-GGUF](https://huggingface.co/tencent/Hy-MT2-1.8B-2Bit-GGUF) — Model card/update on Hugging Face. Tags: gguf, arxiv:2605.22064, base_model:tencent/Hy-MT2-1.8B, base_model:quantized:tencent/Hy-MT2-1.8B, license:apache-2.0, endpoints_compatible, region:us, conversational
- 2026-05-26 `model_update` [Hugging Face model update: tencent/Hy-MT2-1.8B-1.25Bit-GGUF](https://huggingface.co/tencent/Hy-MT2-1.8B-1.25Bit-GGUF) — Model card/update on Hugging Face. Tags: gguf, arxiv:2605.22064, base_model:tencent/Hy-MT2-1.8B, base_model:quantized:tencent/Hy-MT2-1.8B, license:apache-2.0, endpoints_compatible, region:us, conversational
- 2026-05-26 `open_source` [QwenLM/qwen-code release Release v0.16.1-nightly.20260526.e8b79d772](https://github.com/QwenLM/qwen-code/releases/tag/v0.16.1-nightly.20260526.e8b79d772) — <!-- Release notes generated using configuration in .github/release.yml at release/v0.16.1-nightly.20260526.e8b79d772 -->  ## What's Changed * fix(build): clean stale outputs before tsc --build to prevent TS5055 by @doudouOUC in https://git
- 2026-05-26 `open_source` [OpenBMB/PilotDeck release PilotDeck Desktop v0.0.10](https://github.com/OpenBMB/PilotDeck/releases/tag/v0.0.10) — PilotDeck Desktop v0.0.10 macOS build.  Build: aa3499b6 Mode: signed Notarization: .app and DMG both accepted and stapled Verification: macOS L1/L2/L3 full verification passed locally  Assets: - PilotDeck-0.0.10-arm64.dmg: signed, notarized
