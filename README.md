...
- 2026-08-27 `model_update` [Hugging Face model update: Qwen/Qwen3.8-Flash-Next-FP8](https://huggingface.co/Qwen/Qwen3.8-Flash-Next-FP8) — Model card/update on Hugging Face. Tags: transformers, safetensors, qwen4_exp, image-text-to-text, conversational, base_model:Qwen/Qwen3.8-Flash-Next, base_model:quantized:Qwen/Qwen3.8-Flash-Next, license:other
- 2026-08-27 `model_update` [Hugging Face model update: Qwen/Qwen3.8-Flash-Next](https://huggingface.co/Qwen/Qwen3.8-Flash-Next) — Model card/update on Hugging Face. Tags: transformers, safetensors, qwen4_exp, image-text-to-text, conversational, license:other, eval-results, endpoints_compatible
- 2026-08-27 `open_source` [GitHub repository update: QwenLM/Qwen3.8-Flash-Next](https://github.com/QwenLM/Qwen3.8-Flash-Next) — Qwen3.8-Flash-Next is the foundation model developed by Qwen Team, Alibaba Group.
- 2026-08-26 `model_update` [Hugging Face model update: tencent/WeMM-Embedding-9B](https://huggingface.co/tencent/WeMM-Embedding-9B) — Model card/update on Hugging Face. Tags: transformers, safetensors, qwen3_5, image-text-to-text, sentence-transformers, multimodal-embedding, text-embedding, image-embedding
- 2026-08-26 `model_update` [Hugging Face model update: tencent/WeMM-Embedding-4B](https://huggingface.co/tencent/WeMM-Embedding-4B) — Model card/update on Hugging Face. Tags: transformers, safetensors, qwen3_5, image-text-to-text, sentence-transformers, multimodal-embedding, text-embedding, image-embedding
- 2026-08-26 `model_update` [Hugging Face model update: tencent/WeMM-Embedding-2B](https://huggingface.co/tencent/WeMM-Embedding-2B) — Model card/update on Hugging Face. Tags: transformers, safetensors, qwen3_5, image-text-to-text, sentence-transformers, multimodal-embedding, text-embedding, image-embedding
- 2026-08-26 `open_source` [QwenLM/qwen-code release Qwen Code Desktop v0.2.2](https://github.com/QwenLM/qwen-code/releases/tag/desktop-v0.2.2) — <!-- Release notes generated using configuration in .github/release.yml at 7b69293266441dc60846d6d8a50efa1b2cad1eb4 -->  ## What's Changed * fix(goal): converge the three continuation prompts on one guarded contract by @qqqys in https://git
