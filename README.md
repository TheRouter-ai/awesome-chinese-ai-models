...
- 2026-08-05 `model_update` [Hugging Face model update: internlm/Intern-S2-Mobius](https://huggingface.co/internlm/Intern-S2-Mobius) — Model card/update on Hugging Face. Tags: transformers, safetensors, interns2_mobius, image-text-to-text, conversational, custom_code, license:apache-2.0, region:us
- 2026-08-05 `open_source` [GitHub repository update: OpenBMB/StaffDeck](https://github.com/OpenBMB/StaffDeck) — Enterprise Digital Employee Platform
- 2026-08-05 `open_source` [GitHub repository update: InternLM/Intern-S2-Mobius](https://github.com/InternLM/Intern-S2-Mobius) — Intern-S2-Mobius
- 2026-08-04 `api_update` [TheRouter supported model page: deepseek/deepseek-r1](https://therouter.ai/models/deepseek--deepseek-r1) — TheRouter model page with model introduction and OpenAI-compatible access details.
- 2026-08-04 `open_source` [QwenLM/qwen-code release Release v0.21.5](https://github.com/QwenLM/qwen-code/releases/tag/v0.21.5) — <!-- qwen-release-notes:v1 -->  ## Highlights  - Adds an opt-in one-time update bridge for macOS users to migrate from the Electron desktop app to the new Tauri shell. ([#8392](https://github.com/QwenLM/qwen-code/pull/8392)) - Introduces de
...
- 2026-08-04 `open_source` [GitHub repository update: Tencent-Hunyuan/Hunyuan3D-Buffalo1.0](https://github.com/Tencent-Hunyuan/Hunyuan3D-Buffalo1.0) — Repository tracked from an official GitHub organization.
