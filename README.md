...
- 2026-07-15 `open_source` [GitHub repository update: Tencent-Hunyuan/Hy-Embodied-RxBrain-1.0](https://github.com/Tencent-Hunyuan/Hy-Embodied-RxBrain-1.0) — RxBrain: Embodied Cognition Foundation Model with Joint Language–Visual Reasoning and Imagination
- 2026-07-15 `open_source` [GitHub repository update: QwenLM/qwen-code-docs](https://github.com/QwenLM/qwen-code-docs) — A documentation translation tool specifically designed for Qwen Code
- 2026-07-14 `open_source` [QwenLM/qwen-code release Release v0.19.10](https://github.com/QwenLM/qwen-code/releases/tag/v0.19.10) — <!-- qwen-release-notes:v1 -->  ## Highlights  - Multi-workspace support now spans ACP transport, daemon workers, split-view sessions, and workspace-aware actions. ([#6621](https://github.com/QwenLM/qwen-code/pull/6621), [#6635](https://git
...
- 2026-07-14 `open_source` [GitHub repository update: OpenBMB/UltraEval-Audio](https://github.com/OpenBMB/UltraEval-Audio) — Your faithful, impartial partner for audio evaluation — know yourself, know your rivals. 真实评测，知己知彼。
