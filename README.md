...
- 2026-08-20 `model_update` [Hugging Face model update: tencent/UI-Mate-democua-27B](https://huggingface.co/tencent/UI-Mate-democua-27B) — Model card/update on Hugging Face. Tags: transformers, safetensors, qwen3_5, image-text-to-text, computer-use-agent, gui-agent, multimodal, vision-language
- 2026-08-20 `model_update` [Hugging Face model update: tencent/UI-Mate-9B](https://huggingface.co/tencent/UI-Mate-9B) — Model card/update on Hugging Face. Tags: transformers, safetensors, qwen3_5, image-text-to-text, computer-use-agent, gui-agent, multimodal, vision-language
- 2026-08-20 `model_update` [Hugging Face model update: tencent/UI-Mate-27B](https://huggingface.co/tencent/UI-Mate-27B) — Model card/update on Hugging Face. Tags: transformers, safetensors, qwen3_5, image-text-to-text, computer-use-agent, gui-agent, multimodal, vision-language
- 2026-08-20 `open_source` [QwenLM/qwen-code release Release v0.21.15](https://github.com/QwenLM/qwen-code/releases/tag/v0.21.15) — <!-- qwen-release-notes:v2 -->  ## Highlights  - Web Shell now supports inserting file attachments via composer or @ selection, with improved streaming performance and immediate sidebar synchronization. ([#9405](https://github.com/QwenLM/qw
