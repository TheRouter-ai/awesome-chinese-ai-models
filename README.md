...
- 2026-09-08 `model_update` [Hugging Face model update: openbmb/MiniCPM5-2B-GGUF](https://huggingface.co/openbmb/MiniCPM5-2B-GGUF) — Model card/update on Hugging Face. Tags: transformers, gguf, minicpm, minicpm5, llama, text-generation, long-context, tool-calling
- 2026-09-08 `open_source` [GitHub repository update: OpenBMB/Meshy](https://github.com/OpenBMB/Meshy) — Repository tracked from an official GitHub organization.
- 2026-09-07 `model_update` [Hugging Face model update: tencent/EVIE-8B](https://huggingface.co/tencent/EVIE-8B) — Model card/update on Hugging Face. Tags: colpali-engine, safetensors, qwen3_5, vision-language, colbert, late-interaction, multi-vector, vidore
- 2026-09-07 `model_update` [Hugging Face model update: tencent/EVIE-4.5B](https://huggingface.co/tencent/EVIE-4.5B) — Model card/update on Hugging Face. Tags: colpali-engine, safetensors, qwen3_5, vision-language, colbert, late-interaction, multi-vector, matryoshka
- 2026-09-07 `open_source` [QwenLM/qwen-code release Release v0.23.0-nightly.20260907.f1ed3bc31a](https://github.com/QwenLM/qwen-code/releases/tag/v0.23.0-nightly.20260907.f1ed3bc31a) — <!-- Release notes generated using configuration in .github/release.yml at release/v0.23.0-nightly.20260907.f1ed3bc31a -->  ## What's Changed * feat(web-shell): visualize and manage dynamic workflow runs by @qqqys in https://github.com/Qwen
