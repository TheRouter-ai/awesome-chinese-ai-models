...
- 2026-09-16 `model_update` [Hugging Face model update: internlm/Atria-Dawn-Preview-Ascend-w8a8](https://huggingface.co/internlm/Atria-Dawn-Preview-Ascend-w8a8) — Model card/update on Hugging Face. Tags: glm_moe_dsa, arxiv:2609.15818, zh, en, license:mit, region:us
- 2026-09-15 `open_source` [QwenLM/qwen-code release cua-driver-rs v0.20.9](https://github.com/QwenLM/qwen-code/releases/tag/cua-driver-rs-v0.20.9) — Qwen CUA Driver prebuilt binaries (vendored under `packages/cua-driver`).  - **macOS**: codesigned + notarized universal binary + `QwenCuaDriver.app` - **Linux**: unsigned (x86_64 + arm64, glibc 2.31 floor) - **Windows**: unsigned UIAccess
- 2026-09-15 `open_source` [OpenBMB/PilotDeck release v2026.09.16](https://github.com/OpenBMB/PilotDeck/releases/tag/v2026.09.16) — ## What's Changed * Refactor model thinking controls to per-model reasoning effort by @mssssss123 in https://github.com/OpenBMB/PilotDeck/pull/587 * Fix advanced features defaulting to enabled after onboarding by @mssssss123 in https://gith
- 2026-09-15 `model_update` [Hugging Face model update: internlm/Intern-S1-Pro](https://huggingface.co/internlm/Intern-S1-Pro) — Model card/update on Hugging Face. Tags: transformers, safetensors, interns1_pro, text-generation, image-text-to-text, conversational, custom_code, arxiv:2603.25040
- 2026-09-15 `open_source` [GitHub repository update: InternLM/SciDocBench](https://github.com/InternLM/SciDocBench) — Official repository for SciDocBench: a workflow-centered benchmark for scientific document understanding.
- 2026-09-15 `open_source` [deepseek-ai/deepseek-harness release v0.1.6-alpha.1](https://github.com/deepseek-ai/deepseek-harness/releases/tag/dsh-v0.1.6-alpha.1) — [中文](#cn-v0.1.6-alpha.1) | [English](#en-v0.1.6-alpha.1)    <h3 id="cn-v0.1.6-alpha.1">新增功能</h3>    - Web 侧边栏新增终端，支持多标签、Shell 选择和刷新后恢复。 @LegGasai  - 设置中新增已归档会话列表，支持查看和恢复会话。 @tianyicui  - MCP 支持发现和读取资源、使用 URI 模板。内置 Profile 配置 MCP 服务器后可使用共享资源
- 2026-09-14 `model_update` [Hugging Face model update: tencent/Simple-Attention-Sparsification](https://huggingface.co/tencent/Simple-Attention-Sparsification) — Model card/update on Hugging Face. Tags: qwen3, sparse-attention, long-context, sglang, sas, text-generation, dataset:open-r1/OpenR1-Math-220k, arxiv:2609.13141
- 2026-09-14 `open_source` [QwenLM/qwen-code release Release v0.23.4-nightly.20260914.f024b37689](https://github.com/QwenLM/qwen-code/releases/tag/v0.23.4-nightly.20260914.f024b37689) — <!-- Release notes generated using configuration in .github/release.yml at release/v0.23.4-nightly.20260914.f024b37689 -->  ## What's Changed * test: record what the Windows inode gates are hiding, and un-skip one by @yiliang114 in https://
- 2026-09-14 `open_source` [QwenLM/qwen-code release Release v0.23.4](https://github.com/QwenLM/qwen-code/releases/tag/v0.23.4) — <!-- qwen-release-notes:v1 -->  ## Highlights  _See the complete change list below._  ## Breaking Changes  - Removes configurable message-prefix filtering from channels, so eligible messages now follow normal sender, group, mention, and pai
- 2026-09-14 `open_source` [OpenBMB/PilotDeck release v2026.09.15](https://github.com/OpenBMB/PilotDeck/releases/tag/v2026.09.15) — ## What's Changed * fix: preserve literal content and require structured tool calls by @mssssss123 in https://github.com/OpenBMB/PilotDeck/pull/574 * fix: deduplicate realtime reasoning and image queries by @Kaguya-19 in https://github.com/
