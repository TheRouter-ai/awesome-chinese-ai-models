...
- 2026-07-07 `open_source` [GitHub repository update: Tencent-Hunyuan/HiLS-Attention](https://github.com/Tencent-Hunyuan/HiLS-Attention) — Repository tracked from an official GitHub organization.
- 2026-07-06 `model_update` [Hugging Face model update: tencent/Hy3-FP8](https://huggingface.co/tencent/Hy3-FP8) — Model card/update on Hugging Face. Tags: transformers, safetensors, hy_v3, text-generation, hunyuan, hy3, moe, fp8
