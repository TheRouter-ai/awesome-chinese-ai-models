...
- 2026-09-14 `model_update` [Hugging Face model update: internlm/Atria-Dawn-Preview-FP8](https://huggingface.co/internlm/Atria-Dawn-Preview-FP8) — Model card/update on Hugging Face. Tags: safetensors, glm_moe_dsa, zh, en, license:mit, fp8, region:us
- 2026-09-14 `model_update` [Hugging Face model update: internlm/Atria-Dawn-Preview](https://huggingface.co/internlm/Atria-Dawn-Preview) — Model card/update on Hugging Face. Tags: safetensors, glm_moe_dsa, zh, en, license:mit, region:us
- 2026-09-13 `model_update` [Hugging Face model update: internlm/Intern-S2-397B](https://huggingface.co/internlm/Intern-S2-397B) — Model card/update on Hugging Face. Tags: transformers, safetensors, qwen3_5_moe, image-text-to-text, conversational, license:apache-2.0, endpoints_compatible, region:us
