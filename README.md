...
- 2026-07-06 `model_update` [Hugging Face model update: tencent/Hy3](https://huggingface.co/tencent/Hy3) — Model card/update on Hugging Face. Tags: transformers, safetensors, hy_v3, text-generation, hunyuan, hy3, moe, conversational
